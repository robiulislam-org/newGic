-- =====================================================================
-- 🎓 GIC Students & Progress Tracking Update Script (Email/Gmail Auth)
-- Copy and paste this into your Supabase SQL Editor and click RUN.
-- =====================================================================

-- 1. Alter students table to make phone nullable and add email column (if it doesn't exist)
...
-- 3. Create function to login or create a student by email
