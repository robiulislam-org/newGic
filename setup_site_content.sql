...
values (
  ...
  '{
    ...
    "description": "হাফেজ ও আলেম শিক্ষকদের সাথে সহীহ শুদ্ধ কোরআন শিক্ষা। শিশু থেকে বয়স্ক — পরিবারের সকলের জন্য। বিশ্বের যেকোনো দেশ থেকে বাংলায় শিখুন।",
...
values (
  ...
  '{
    ...
    "subtitle": "আধুনিক পদ্ধতি, হাফেজ-আলেম শিক্ষক এবং সম্পূর্ণ বাংলায় পাঠদানের মাধ্যমে অনন্য শিক্ষার অভিজ্ঞতা।",
    "cards": [
      { "id": 1, "icon": "🎓", "title": "হাফেজ-আলেম শিক্ষক", "desc": "আমাদের সকল শিক্ষক হাফেজ ও আলেম — তাজউইদে দক্ষ এবং আন্তর্জাতিক মানের পাঠদানে অভিজ্ঞ।" },
...
values (
  ...
  '{
    ...
    "story": "আমাদের লক্ষ্য বিশ্বব্যাপী ছড়িয়ে থাকা বাংলাভাষী মুসলিমদের কাছে বিশুদ্ধ কোরআনের শিক্ষা সহজে পৌঁছে দেওয়া। দেশ-বিদেশের অভিজ্ঞ হাফেজ ও আলেম শিক্ষকদের তত্ত্বাবধানে আমরা শিক্ষার্থীদের আন্তরিকতার সাথে গড়ে তুলছি।",
    ...
    "stats": [
      ...
      { "num": "১০০+", "label": "যোগ্য হাফেজ ও আলেম শিক্ষক" },
