...
const DEFAULT_SITE_CONTENT = {
  ...
  hero: {
    ...
    points: [
      ...
      "কোরআন শিক্ষা ও স্কুল-কলেজের সকল বিষয়"
    ],
  ...
  footer: {
    about_text: "Global Islamic Care — দেশ ও বিদেশের শিক্ষার্থীদের জন্য বিশ্বস্ত মুসলিম শিক্ষক ও শিক্ষিকা প্ল্যাটফর্ম (কোরআন ও স্কুল-কলেজের সকল বিষয় — অনলাইন ও হোম টিউশন)।",
    copyright: "© ২০২৬ Global Islamic Care. সর্বস্বত্ব সংরক্ষিত।",
    developer_credit: "Powered by Global Islamic Care Tech"
  }
};

const GIC_CONTENT_VERSION = "2026.09.13.v2";
